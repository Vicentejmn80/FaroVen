...
export type SupportResourceKind = 'crisis_line' | 'volunteer_psych' | 'support_group' | 'child_activity'
export type SupportRequestStatus = 'pending' | 'assigned' | 'contacted' | 'closed'
export type SupportContactMethod = 'whatsapp' | 'phone' | 'none'
...
export type CoordinatorSiteType = 'hospital' | 'supply_center' | 'shelter'
export type ReportSiteType = 'hospital' | 'shelter' | 'supply_center'
...
export interface Report {
  ...
  site_type: ReportSiteType | null
  site_id: string | null
  site_label: string | null
  other_place_name: string | null
  latitude: number | null
  longitude: number | null
  status: ReportStatus
...
export type CoordinatorReport = AdminReport
...
export interface SupportRequest {
  id: string
  for_whom: 'self' | 'child' | 'family' | 'other'
  topic: string | null
  description: string | null
...
export const SUPPORT_KIND_LABELS: Record<SupportResourceKind, string> = {
  crisis_line: 'Línea de crisis',
  volunteer_psych: 'Psicólogo/a voluntario/a',
  support_group: 'Grupo de apoyo',
  child_activity: 'Actividad para niños',
}

export const SUPPORT_KIND_EMOJI: Record<SupportResourceKind, string> = {
  crisis_line: '🆘',
  volunteer_psych: '🧠',
  support_group: '🤝',
  child_activity: '🎨',
...
export const REPORT_SITE_TYPE_LABELS: Record<ReportSiteType, string> = {
  hospital: 'Hospital',
  shelter: 'Refugio',
  supply_center: 'Acopio',
}
