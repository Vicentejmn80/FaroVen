...
import { Layout } from '@/legacy-app/layout'
import { VolunteerLayout } from '@/legacy-app/volunteer-layout'
import { AdminLayout } from '@/legacy-app/admin-layout'
    ...
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="apoyo" element={<AdminSupportPage />} />
        </Route>
      </Route>
    </Routes>
  )
