...
export const VALID_TRANSITIONS: Record<PipelineStage, readonly PipelineStage[]> = {
  ...
  [PIPELINE_STAGES.PENDING_REVIEW]: [PIPELINE_STAGES.VALIDATING, PIPELINE_STAGES.OPEN_FOR_APPLICATIONS, PIPELINE_STAGES.AWAITING_INFO, PIPELINE_STAGES.ARCHIVED],
  [PIPELINE_STAGES.VALIDATING]: [PIPELINE_STAGES.ASSIGNED, PIPELINE_STAGES.OPEN_FOR_APPLICATIONS, PIPELINE_STAGES.AWAITING_INFO, PIPELINE_STAGES.ARCHIVED],
  [PIPELINE_STAGES.AWAITING_INFO]: [PIPELINE_STAGES.PENDING_REVIEW, PIPELINE_STAGES.OPEN_FOR_APPLICATIONS, PIPELINE_STAGES.ARCHIVED],
  [PIPELINE_STAGES.OPEN_FOR_APPLICATIONS]: [PIPELINE_STAGES.ASSIGNED, PIPELINE_STAGES.ARCHIVED],
...
export const TRANSITION_TO_EVENT: Record<string, CaseEventType> = {
  ...
  [`${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}->${PIPELINE_STAGES.ASSIGNED}`]: CASE_EVENT_TYPES.CASE_VALIDATED,
...
export const PIPELINE_STAGE_LABELS: Record<PipelineStage, string> = {
  ...
  [PIPELINE_STAGES.OPEN_FOR_APPLICATIONS]: 'Aceptando postulaciones',
