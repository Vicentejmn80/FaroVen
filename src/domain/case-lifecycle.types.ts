...
export const VALID_TRANSITIONS: Record<PipelineStage, readonly PipelineStage[]> = {
  ...
  [PIPELINE_STAGES.VALIDATING]: [PIPELINE_STAGES.ASSIGNED, PIPELINE_STAGES.AWAITING_INFO],
  [PIPELINE_STAGES.AWAITING_INFO]: [PIPELINE_STAGES.PENDING_REVIEW, PIPELINE_STAGES.ARCHIVED],
  [PIPELINE_STAGES.ASSIGNED]: [PIPELINE_STAGES.ACCEPTED, PIPELINE_STAGES.PENDING_REVIEW],
  [PIPELINE_STAGES.ACCEPTED]: [PIPELINE_STAGES.IN_ATTENTION],
  [PIPELINE_STAGES.IN_ATTENTION]: [PIPELINE_STAGES.RESOLVED, PIPELINE_STAGES.AWAITING_INFO],
