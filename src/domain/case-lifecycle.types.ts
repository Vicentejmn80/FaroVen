 ...
 * - Dentro de "Esperando cobertura" se puede pivotar radar ↔ centro
...
export const TRANSITION_TO_EVENT: Record<string, CaseEventType> = {
  ...
  [`${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}->${PIPELINE_STAGES.AWAITING_CENTER_CONFIRMATION}`]: CASE_EVENT_TYPES.CASE_AWAITING_CENTER,
  ...
  [`${PIPELINE_STAGES.AWAITING_CENTER_CONFIRMATION}->${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}`]: CASE_EVENT_TYPES.CASE_OPENED_FOR_APPLICATIONS,
  ...
  [`${PIPELINE_STAGES.ASSIGNED}->${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}`]: CASE_EVENT_TYPES.CASE_OPENED_FOR_APPLICATIONS,
  ...
  [`${PIPELINE_STAGES.ACCEPTED}->${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}`]: CASE_EVENT_TYPES.CASE_OPENED_FOR_APPLICATIONS,
  ...
  [`${PIPELINE_STAGES.IN_ATTENTION}->${PIPELINE_STAGES.OPEN_FOR_APPLICATIONS}`]: CASE_EVENT_TYPES.CASE_OPENED_FOR_APPLICATIONS,
